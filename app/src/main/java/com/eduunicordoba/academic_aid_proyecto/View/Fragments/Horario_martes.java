 ...
 * Use the {@link Horario_martes#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Horario_martes extends Fragment {
     ...
     * @return A new instance of fragment Horario_martes.
     */
    // TODO: Rename and change types and number of parameters
    public static Horario_martes newInstance(String param1, String param2) {
        Horario_martes fragment = new Horario_martes();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_horario_martes, container, false);
        AsociarElementos(view);
        btn=view.findViewById(R.id.guardar_martes);
            ...
            public void onClick(View view) {
                for (int i=0;i<ids.length;i++){
                    ...
                    if(checkBox[i].isChecked()){
                        ...
                        Horario horario=new Horario("Martes",checkBox[i].getText().toString(),auth.getUid());
